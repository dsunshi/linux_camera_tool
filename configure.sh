...
sudo apt install nvidia-cuda-toolkit -y                     # CUDA toolkit (must install before OpenCV!)
./OpenCV3.2withContrib.sh                                   # OpenCV 3.2 with Contrib install script (CUDA supported)
